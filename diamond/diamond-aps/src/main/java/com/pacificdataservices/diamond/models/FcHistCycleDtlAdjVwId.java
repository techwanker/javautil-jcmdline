...
/**
 * FcHistCycleDtlAdjVwId generated by hbm2java
 */
@Embeddable
public class FcHistCycleDtlAdjVwId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FcHistCycleDtlAdjVwId) ) return false;
		 FcHistCycleDtlAdjVwId castOther = ( FcHistCycleDtlAdjVwId ) other; 

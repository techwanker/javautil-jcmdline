...
/**
 * ApsSupplyId generated by hbm2java
 */
@Embeddable
public class ApsSupplyId  implements java.io.Serializable {
     ...
     private BigDecimal poLineHdrNbr;

    public ApsSupplyId() {
    }

    public ApsSupplyId(String splyIdentifier, Character availTypeCd, BigDecimal lotNbr, Integer itemNbr, String facility, Integer apsSplySubPoolNbr, BigDecimal orgNbrMfr, BigDecimal orgNbrVnd, Date availDt, BigDecimal grossAvailQty, String lotUm, String revLvl, Integer pkSupply, BigDecimal lotCost, String cntryCdOrigin, Date mfrDate, Date expireDt, Date rcptDt, Date apsAvailDt, BigDecimal woItemNbr, String availDtId, BigDecimal poLineHdrNbr) {
    ...
    @Column(name="PO_LINE_HDR_NBR", precision=22, scale=0)
    public BigDecimal getPoLineHdrNbr() {
        return this.poLineHdrNbr;
    }
    
    public void setPoLineHdrNbr(BigDecimal poLineHdrNbr) {
        this.poLineHdrNbr = poLineHdrNbr;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ApsSupplyId) ) return false;
		 ApsSupplyId castOther = ( ApsSupplyId ) other; 

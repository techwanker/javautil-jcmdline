...
/**
 * ApsCustMfrVwId generated by hbm2java
 */
@Embeddable
public class ApsCustMfrVwId  implements java.io.Serializable {
    ...
    public ApsCustMfrVwId() {
    }

	
    public ApsCustMfrVwId(int itemNbr, String itemCd, int orgNbrCust, String orgCdCust, String orgNmCust, int orgNbrMfr, String orgCdMfr, String orgNmMfr, String mfrRestrictId) {
    ...
    public ApsCustMfrVwId(int itemNbr, String itemCd, int orgNbrCust, String orgCdCust, String orgNmCust, int orgNbrMfr, String orgCdMfr, String orgNmMfr, String mfrRestrictId, Date effDtBeg, Date effDtEnd) {
       this.itemNbr = itemNbr;
       this.itemCd = itemCd;
       this.orgNbrCust = orgNbrCust;
       this.orgCdCust = orgCdCust;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ApsCustMfrVwId) ) return false;
		 ApsCustMfrVwId castOther = ( ApsCustMfrVwId ) other; 

...
/**
 * FcHistCycleActVwId generated by hbm2java
 */
@Embeddable
public class FcHistCycleActVwId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FcHistCycleActVwId) ) return false;
		 FcHistCycleActVwId castOther = ( FcHistCycleActVwId ) other; 

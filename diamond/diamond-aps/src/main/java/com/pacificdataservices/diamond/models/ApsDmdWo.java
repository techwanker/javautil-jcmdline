...
/**
 * ApsDmdWo generated by hbm2java
 */
@Entity
@Table(name="APS_DMD_WO"
)
public class ApsDmdWo  implements java.io.Serializable {
    ...
    public ApsDmdWo(String dmdCd, int itemNbrDmd, int woDtlNbr, Date needByDt, int apsSrcRuleSetNbr, int orgNbrCust, String orgCdCust, String fcstGrp, String mixMfrLotFlg, BigDecimal componentQtyPerUnit, short custAllocPrty) {
        this.dmdCd = dmdCd;

...
/**
 * FcHistCycleDtlActVwId generated by hbm2java
 */
@Embeddable
public class FcHistCycleDtlActVwId  implements java.io.Serializable {
    ...
    public FcHistCycleDtlActVwId() {
    }

    public FcHistCycleDtlActVwId(Serializable fcItemMastNbr, Serializable orgNbrCust, Serializable fcstGrp, Serializable itemNbr, Serializable itemCd, Serializable stdCost, Serializable listPrice, Serializable cycle, Serializable jan, Serializable feb, Serializable mar, Serializable apr, Serializable may, Serializable jun, Serializable jul, Serializable aug, Serializable sep, Serializable oct, Serializable nov, Serializable dec, Serializable tot) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FcHistCycleDtlActVwId) ) return false;
		 FcHistCycleDtlActVwId castOther = ( FcHistCycleDtlActVwId ) other; 

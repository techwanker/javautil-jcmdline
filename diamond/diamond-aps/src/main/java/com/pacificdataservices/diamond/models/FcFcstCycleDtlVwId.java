...
/**
 * FcFcstCycleDtlVwId generated by hbm2java
 */
@Embeddable
public class FcFcstCycleDtlVwId  implements java.io.Serializable {
     ...
     private Serializable consumedTot;

    public FcFcstCycleDtlVwId() {
    }

    public FcFcstCycleDtlVwId(Serializable fcItemMastNbr, Serializable orgNbrCust, Serializable orgCdCust, Serializable orgNmCust, Serializable fcstGrp, Serializable itemNbr, Serializable itemCd, Serializable itemDescr, Serializable stkUm, Serializable stdCost, Serializable listPrice, Serializable cycle, Serializable fcItemFcstMdlNbr, Serializable chosenFlg, Serializable rawFcstJan, Serializable rawFcstFeb, Serializable rawFcstMar, Serializable rawFcstApr, Serializable rawFcstMay, Serializable rawFcstJun, Serializable rawFcstJul, Serializable rawFcstAug, Serializable rawFcstSep, Serializable rawFcstOct, Serializable rawFcstNov, Serializable rawFcstDec, Serializable rawTot, Serializable adjFcstJan, Serializable adjFcstFeb, Serializable adjFcstMar, Serializable adjFcstApr, Serializable adjFcstMay, Serializable adjFcstJun, Serializable adjFcstJul, Serializable adjFcstAug, Serializable adjFcstSep, Serializable adjFcstOct, Serializable adjFcstNov, Serializable adjFcstDec, Serializable adjTot, Serializable consumedFcstJan, Serializable consumedFcstFeb, Serializable consumedFcstMar, Serializable consumedFcstApr, Serializable consumedFcstMay, Serializable consumedFcstJun, Serializable consumedFcstJul, Serializable consumedFcstAug, Serializable consumedFcstSep, Serializable consumedFcstOct, Serializable consumedFcstNov, Serializable consumedFcstDec, Serializable consumedTot) {
    ...
    @Column(name="RAW_TOT")
    public Serializable getRawTot() {
        return this.rawTot;
    }
    
    public void setRawTot(Serializable rawTot) {
        this.rawTot = rawTot;
    }
    ...
    @Column(name="ADJ_TOT")
    public Serializable getAdjTot() {
        return this.adjTot;
    }
    
    public void setAdjTot(Serializable adjTot) {
        this.adjTot = adjTot;
    }
    ...
    @Column(name="CONSUMED_TOT")
    public Serializable getConsumedTot() {
        return this.consumedTot;
    }
    
    public void setConsumedTot(Serializable consumedTot) {
        this.consumedTot = consumedTot;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FcFcstCycleDtlVwId) ) return false;
		 FcFcstCycleDtlVwId castOther = ( FcFcstCycleDtlVwId ) other; 
 ...
 && ( (this.getRawTot()==castOther.getRawTot()) || ( this.getRawTot()!=null && castOther.getRawTot()!=null && this.getRawTot().equals(castOther.getRawTot()) ) )
 ...
 && ( (this.getAdjTot()==castOther.getAdjTot()) || ( this.getAdjTot()!=null && castOther.getAdjTot()!=null && this.getAdjTot().equals(castOther.getAdjTot()) ) )
 ...
 && ( (this.getConsumedTot()==castOther.getConsumedTot()) || ( this.getConsumedTot()!=null && castOther.getConsumedTot()!=null && this.getConsumedTot().equals(castOther.getConsumedTot()) ) );
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getRawTot() == null ? 0 : this.getRawTot().hashCode() );
         ...
         result = 37 * result + ( getAdjTot() == null ? 0 : this.getAdjTot().hashCode() );
         ...
         result = 37 * result + ( getConsumedTot() == null ? 0 : this.getConsumedTot().hashCode() );
         return result;
   }   

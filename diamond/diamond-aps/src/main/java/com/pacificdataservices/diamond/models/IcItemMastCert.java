...
/**
 * IcItemMastCert generated by hbm2java
 */
@Entity
@Table(name="IC_ITEM_MAST_CERT"
)
public class IcItemMastCert  implements java.io.Serializable {


     private IcItemMastCertId id;
     private IcCertCd icCertCd;
     private IcItemMast icItemMast;
     private int utUserNbr;
     private Date lastModDt;

    public IcItemMastCert() {
    }

    public IcItemMastCert(IcItemMastCertId id, IcCertCd icCertCd, IcItemMast icItemMast, int utUserNbr, Date lastModDt) {
       this.id = id;
    ...
    public IcItemMastCertId getId() {
        return this.id;
    }
    
    public void setId(IcItemMastCertId id) {
        this.id = id;
    }

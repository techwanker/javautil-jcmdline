...
/**
 * TmpApsDmdSs generated by hbm2java
 */
@Entity
@Table(name="TMP_APS_DMD_SS"
)
public class TmpApsDmdSs  implements java.io.Serializable {
    ...
    public TmpApsDmdSs(String dmdCd, int itemNbrDmd, int itemNbrAllocRqst, int fcItemMastNbr, int apsSrcRuleSetNbr, int orgNbrCust, String orgCdCust, String contractCustFlg, String fcstGrp) {
        this.dmdCd = dmdCd;
    ...
    public TmpApsDmdSs(String dmdCd, String dmdTypeCd, int itemNbrDmd, int itemNbrAllocRqst, int fcItemMastNbr, Date rqstDt, int apsSrcRuleSetNbr, int orgNbrCust, String orgCdCust, BigDecimal openQty, BigDecimal openQtyAdj, String contractCustFlg, BigDecimal custAllocPrty, String revLvl, Integer orgNbrMfrRqst, String fcstGrp) {
       this.dmdCd = dmdCd;

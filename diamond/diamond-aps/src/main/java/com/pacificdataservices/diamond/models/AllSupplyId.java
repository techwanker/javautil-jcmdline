...
/**
 * AllSupplyId generated by hbm2java
 */
@Embeddable
public class AllSupplyId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AllSupplyId) ) return false;
		 AllSupplyId castOther = ( AllSupplyId ) other; 

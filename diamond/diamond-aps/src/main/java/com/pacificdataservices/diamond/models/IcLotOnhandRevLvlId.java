...
/**
 * IcLotOnhandRevLvlId generated by hbm2java
 */
@Embeddable
public class IcLotOnhandRevLvlId  implements java.io.Serializable {
    ...
    public IcLotOnhandRevLvlId() {
    }

    public IcLotOnhandRevLvlId(Integer lotNbr, Integer itemNbr, String revLvl) {
       this.lotNbr = lotNbr;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof IcLotOnhandRevLvlId) ) return false;
		 IcLotOnhandRevLvlId castOther = ( IcLotOnhandRevLvlId ) other; 

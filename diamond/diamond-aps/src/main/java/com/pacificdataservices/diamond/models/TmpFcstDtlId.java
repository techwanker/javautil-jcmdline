...
/**
 * TmpFcstDtlId generated by hbm2java
 */
@Embeddable
public class TmpFcstDtlId  implements java.io.Serializable {
    ...
    public TmpFcstDtlId(String groupingString, String dmdType) {
        this.groupingString = groupingString;
        this.dmdType = dmdType;
    }
    public TmpFcstDtlId(String groupingString, Short sortSeq, String dmdType, BigDecimal qtyMnth1, BigDecimal qtyMnth2, BigDecimal qtyMnth3, BigDecimal qtyMnth4, BigDecimal qtyMnth5, BigDecimal qtyMnth6, BigDecimal qtyMnth7, BigDecimal qtyMnth8, BigDecimal qtyMnth9, BigDecimal qtyMnth10, BigDecimal qtyMnth11, BigDecimal qtyMnth12) {
       this.groupingString = groupingString;
    ...
    @Column(name="DMD_TYPE", nullable=false, length=30)
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TmpFcstDtlId) ) return false;
		 TmpFcstDtlId castOther = ( TmpFcstDtlId ) other; 
         
		 return ( (this.getGroupingString()==castOther.getGroupingString()) || ( this.getGroupingString()!=null && castOther.getGroupingString()!=null && this.getGroupingString().equals(castOther.getGroupingString()) ) )

...
/**
 * TmpApsDmdFc generated by hbm2java
 */
@Entity
@Table(name="TMP_APS_DMD_FC"
)
public class TmpApsDmdFc  implements java.io.Serializable {
    ...
    public TmpApsDmdFc(String dmdCd, int itemNbrDmd, Date rqstDt, int apsSrcRuleSetNbr, int orgNbrCust, String orgCdCust, short custAllocPrty, int fcItemMastNbr, String fcstGrp, String hardAllocFcWithinLeadTm) {
        this.dmdCd = dmdCd;
    ...
    public TmpApsDmdFc(String dmdCd, String dmdTypeCd, int itemNbrDmd, Date rqstDt, int apsSrcRuleSetNbr, int orgNbrCust, String orgCdCust, BigDecimal openQty, BigDecimal openQtyAdj, String contractCustFlg, short custAllocPrty, String revLvl, Integer orgNbrMfrRqst, int fcItemMastNbr, String fcstGrp, String hardAllocFcWithinLeadTm) {
       this.dmdCd = dmdCd;

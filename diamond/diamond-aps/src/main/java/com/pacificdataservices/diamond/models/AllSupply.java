...
/**
 * AllSupply generated by hbm2java
 */
@Entity
@Table(name="ALL_SUPPLY"
)
public class AllSupply  implements java.io.Serializable {


     private AllSupplyId id;

    public AllSupply() {
    }

    public AllSupply(AllSupplyId id) {
       this.id = id;
    }
    ...
    public AllSupplyId getId() {
        return this.id;
    }
    
    public void setId(AllSupplyId id) {
        this.id = id;
    }

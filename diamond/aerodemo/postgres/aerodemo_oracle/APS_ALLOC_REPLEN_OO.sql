...
--------------------------------------------------------
  ...
  CREATE TABLE "INTERFAST"."APS_ALLOC_REPLEN_OO" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "DIAMOND" ;
   ...
   COMMENT ON COLUMN "INTERFAST"."APS_ALLOC_REPLEN_OO"."SUBST_ID" IS 'G-Global Substitute Allocated,
		C-Customer Specified Subsitute allocated';
   COMMENT ON COLUMN "INTERFAST"."APS_ALLOC_REPLEN_OO"."ALLOC_TYPE_ID" IS 'R-Reuested for Bind,

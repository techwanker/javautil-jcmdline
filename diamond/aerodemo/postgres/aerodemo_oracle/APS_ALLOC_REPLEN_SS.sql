...
--------------------------------------------------------
  ...
  CREATE TABLE "INTERFAST"."APS_ALLOC_REPLEN_SS" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "DIAMOND" ;
   ...
   COMMENT ON COLUMN "INTERFAST"."APS_ALLOC_REPLEN_SS"."SUBST_ID" IS 'G-Global Substitute Allocated,
		C-Customer Specified Subsitute allocated';
   COMMENT ON COLUMN "INTERFAST"."APS_ALLOC_REPLEN_SS"."ALLOC_TYPE_ID" IS 'R-Reuested for Bind,

...
--------------------------------------------------------
  ...
  CREATE TABLE "INTERFAST"."APS_ALLOC_ONHAND_FC" 
 ...
 NOCOMPRESS NOLOGGING
  ...
  TABLESPACE "DIAMOND" ;
   ...
   COMMENT ON COLUMN "INTERFAST"."APS_ALLOC_ONHAND_FC"."SUBST_ID" IS 'G-Global Substitute Allocated,
		C-Customer Specified Subsitute allocated';
   COMMENT ON COLUMN "INTERFAST"."APS_ALLOC_ONHAND_FC"."ALLOC_TYPE_ID" IS 'R-Reuested for Bind,

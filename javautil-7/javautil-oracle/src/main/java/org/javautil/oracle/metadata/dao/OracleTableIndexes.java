...
// private Map <String,OracleIndex> indexByName = new
// TreeMap<String,OracleIndex>();
//
// public OracleTableIndexes(Connection conn, OracleTable table) throws
// SQLException {
// if (conn == null) {
...
// }
//
// List<OracleIndexColumn> columns = IndexColumnsDAO.getForTable(conn,
// table.getSchemaName(), table.getTableName());
// for (OracleIndexColumn column : columns) {
// OracleIndex index = indexByName.get(column.getIndexName());
// if (index == null) {
// throw new IllegalStateException("Cannot locate index for indexColumn " +
// column);
// }

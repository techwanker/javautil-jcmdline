...
public class OracleTableColumnDAO {
	...
	public static List<OracleTableColumn> getForTable(Connection conn, String owner, String tableName, boolean useDba,
	...
	public static void getRow(ResultSet rset, OracleTableColumn row) throws java.sql.SQLException {

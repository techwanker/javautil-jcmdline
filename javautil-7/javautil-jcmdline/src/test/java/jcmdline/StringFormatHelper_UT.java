 ...
 *
 * jcmdline Rel. @VERSION@ $Id: StringFormatHelper_UT.java,v 1.2 2002/12/07 14:30:49 lglawrence Exp $
 *
 * Classes:
 ...
 */
public class StringFormatHelper_UT extends BetterTestCase {

    /**
     * a StringFormatHelper to use during tests
     */
    private static final StringFormatHelper sHelper = 
        StringFormatHelper.getHelper();
     ...
     */
    public StringFormatHelper_UT(String name) {
        super(name);
    }
    ...
    public void testFormatMaxLenWNL() {
        ...
        assertEquals("format of String of length = maxLength failed",
                     s, newS);
    }
    ...
    public void testBlockedText() {
        ...
        String expected = "     This is\n     the String\n     to be used\n" +
                          "     for my\n     test";
        assertEquals("formatBlockedText(s, 5, 15) failed",
                     expected, sHelper.formatBlockedText(s, 5, 15));
    }
    ...
    public void testBreakStringNoNewLine() {
        ...
        assertEquals("breakString returned wrong first String",
                     "This is my\n", a[0]);
        assertEquals("breakString returned wrong remainder String",
                     "test String", a[1]);
        s = "This is my      test String";
        a = sHelper.breakString(s, 10);
        assertEquals("breakString returned wrong first String " +
                        "when multiple spaces at break point",
                     "This is my\n", a[0]);
        assertEquals("breakString returned wrong remainder String " +
                        "when multiple spaces at break point",
                     "test String", a[1]);
    ...
    public void testBreakStringEmpty() {
        ...
        assertEquals("breakString returned wrong first String",
                     "", a[0]);
        assertNull("breakString returned wrong remainder String",
                   a[1]);
    }
    ...
    /**
     * Tests breakString() on a String with multiple spaces at the 
     * break point
     */
    ...
    /**
     * Tests breakString() on a String shorter than maxLen, ending with a
     * newline
     */
    ...
    public void testFormatLabeledList() {
        ...
        String[] texts = new String[] {
            "This is the description for label1",
        ...
        String expected = "label1 : This is the description for label1\n" +
            ...
            "         for label2\n";
        assertEquals("formatLabeledList() returned wrong string",
                     expected, 
    ...
    public void testFormatLabeledList2() {
        ...
        String expected = 
            "label1 : This is the description for label1\n" +
            "label2IsaLongLabel : \n" +
    ...
    public static void main (String[] args) {
        doMain(args, StringFormatHelper_UT.class);
    }
}

 ...
 * in V$SESSION_WAIT. For any Oracle release a full list of wait events and the
 * values in P1, P2 and P3 below can be seen in V$EVENT_NAME
 * 
 * ela Elapsed time for the operation. p1 P1 for the given wait event. p2 P2 for
 * the given wait event. p3 P3 for the given wait event.
 * 

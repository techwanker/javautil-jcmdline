...
public class Column implements ColumnAttributes {
	...
	public Column(final ResultSet rs) throws java.sql.SQLException {
		...
		attributeName = StringUtils.attributeName(columnName);
	...
	/*
	 * is NULL allowed? Assumable values <ul> <li>0 -
	 * java.sql.DatabaseMetaData.columnNoNulls - might not allow NULL values</li>
	 * <li>1 - java.sql.DatabaseMetaData.columnNullable - definitely allows NULL
	 * values</li> <li>2 - java.sql.DatabaseMetaData.columnNullableUnknown -
	 * nullability unknown</li> </ul>
	 */
	...
	public Column setComments(String comments) {

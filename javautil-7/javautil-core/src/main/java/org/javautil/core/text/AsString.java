...
import static org.javautil.core.text.ToStringStyleFlags.DONT_EMIT_STATICS;
import static org.javautil.core.text.ToStringStyleFlags.DONT_EMIT_TRANSIENTS;
import static org.javautil.core.text.ToStringStyleFlags.USE_SHORT_CLASS_NAME;
...
public class AsString {
	...
	public String toString(final Object object) {
		...
		if (excludeFieldNames != null) {
			...
			string = ReflectionToStringBuilder.toString(object, style, style.getEmitTransients(), style.getEmitStatics());
		}
		return string;
